...
// create services
var store = DataStorageService.createProxy(vertx, 'vertx2go.places');

// Allow events for the designated addresses in/out of the event bus bridge
var opts = {
  inboundPermitteds:  [{address: 'vertx2go.recommendations'}],
  outboundPermitteds: [{address: 'vertx2go.recommendations.announce'}]
};
